...
void Light::setAmb(glm::fvec4 amb) { ambient = amb; uploadL(); }; //setDiff(), setSpec()
void Light::setDiffuse(glm::fvec4 amb) { diffuse = amb; uploadL(); }; //setDiff(), setSpec()
void Light::setSpecular(glm::fvec4 amb) { specular = amb; uploadL(); }; //setDiff(), setSpec()
void Light::setPosDir(glm::fvec4 amb) { posDir = amb; uploadL(); }; //setDiff(), setSpec()
