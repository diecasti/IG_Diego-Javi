...
//-------------------------------------------------------------------------
//Rotate, translate y scale
//Respecto a la matriz identidad: dmat4(1), respecto a su matriz modelMat() o mModelMat
//SCALE
//gObjects.back()->setModelMat(glm::scale(dmat4(1), dvec3(2.0, 2.0, 2.0)));
//-------------------------------------------------------------------------
